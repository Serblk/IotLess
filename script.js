...
function loadPdf(idx){
  ...
  iframe.src=encodeURI(item.file);
  ...
  iframe.onerror=function(){
    container.innerHTML='<p style="padding:40px;text-align:center;color:var(--text2)">Не удалось отобразить PDF. <a href="'+encodeURI(item.file)+'" target="_blank">Открыть в новой вкладке</a></p>';
  };
